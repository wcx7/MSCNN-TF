...
class TransformerBlock(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio, dropout=0.1):
        ...
        # self.self_attn = nn.MultiheadAttention(embed_dim=dim, num_heads=num_heads, batch_first=True)    # 不用dropout怎么样
...
if __name__ == '__main__':
    ...
    input_tensor = torch.rand(32, 113, input_dim)    #  Batch size: 32;  Sequence length: 113,channel number of EEG channels;  input_dim:length of the embeded EEG window or slice.
